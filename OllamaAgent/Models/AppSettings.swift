...
final class AppSettings: ObservableObject {
    ...
    init(defaults: UserDefaults = .standard, legacyDefaults: UserDefaults? = nil) {
        ...
        Self.migrateLegacyDefaultsIfNeeded(
            defaults: defaults,
            legacyDefaults: legacyDefaults ?? (defaults === UserDefaults.standard ? UserDefaults(suiteName: "com.local.OllamaDashboard") : nil)
        )
...
private enum Keys {
    ...
    static let all = [
        ...
        enableCLIControls,
        ollamaCLIPath,
        showAdvancedServiceNotes,
        enableProxy,
        proxyPort,
        confirmUnload,
        enablePromptGuardrails,
        promptGuardrailResponseMode,
        promptGuardrailWarnPromptCharacters,
        promptGuardrailBlockPromptCharacters,
        promptGuardrailWarnBodyBytes,
        promptGuardrailBlockBodyBytes,
        promptGuardrailWarnMessages,
        promptGuardrailBlockMessages,
        promptGuardrailWarnContextRatio,
        promptGuardrailBlockContextRatio
    ]
}
