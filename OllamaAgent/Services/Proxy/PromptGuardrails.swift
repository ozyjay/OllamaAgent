...
enum PromptGuardrailResponder {
    ...
    private static func openAIStreamResponse(content: String, model: String?) -> PromptGuardrailHTTPResponse {
        let modelName = model ?? "ollama-agent-guardrail"
